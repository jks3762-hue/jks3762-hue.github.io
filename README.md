[index-2.html](https://github.com/user-attachments/files/25353302/index-2.html)
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        <header>
            ...
            <div style="max-width: 800px; margin: 30px auto 0; background: rgba(255,255,255,0.95); padding: 25px 35px; border-radius: 12px; box-shadow: 0 8px 30px rgba(0,0,0,0.15);">
                ...
                <p style="font-size: 1.15rem; line-height: 1.8; color: var(--text); margin: 0;">
                    Unlike static calendars, our AI continuously adjusts your plan based on weekly performance, identifies weak areas, prevents burnout, and projects your score trajectory—helping you study smarter, not just harder.
                </p>
            </div>
        </header>
        ...
        <div id="dashboardSection" class="hidden">
            ...
            <!-- Study Schedule -->
            <div class="card">
                <h2>📅 Your Adaptive Study Schedule</h2>
